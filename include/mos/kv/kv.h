...
MOSAPI int MOSCConv kv_vread(kv_t **, mosiop_t, const char *, ...);
MOSAPI int MOSCConv kv_vawrite(kv_t *, mosiop_t, const char *, va_list);
MOSAPI int MOSCConv kv_vwrite(kv_t *, mosiop_t, const char *, ...);
...
MOSAPI int MOSCConv kvvadd(kv_t *, mosiop_t, const char *, const char *, ...);
...
MOSAPI int MOSCConv kvvset(kv_t *, mosiop_t, const char *, const char *, ...);
